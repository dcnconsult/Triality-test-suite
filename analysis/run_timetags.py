...
DEFAULT_OUTDIR = OUT_DIR / "timetag_bispec"
...
def main():
    ...
    np.savez(outdir / "timetag_bispec.npz", f=f, b2=b2, peak=list(peak.items()))
    plot_annot(f, b2, peak, f3_est=None, outpng=str(outdir / "timetag_bicoherence.png"))
    print("Peak:", peak)
